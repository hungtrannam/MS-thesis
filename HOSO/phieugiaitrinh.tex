...
\begin{table}[H]\centering\footnotesize
	\begin{tabular*}{\columnwidth}{@{\extracolsep\fill}p{0.5cm}p{7cm}p{7cm}@{\extracolsep\fill}}
		\toprule
		...
		\midrule 
		4 & Định nghĩa độ nhạy và độ chính xác &\\
		5 & Kết cấu Brodatz là gì, học viên hãy mô tả chi tiết dữ liệu và phương pháp giải quyết &\\
		6 & Tại sao sử dụng một hình ảnh để nhận dạng mà không phải nhiều hình ảnh? &\\
