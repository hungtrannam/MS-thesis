...
\begin{frame}{1.5. Phân tích chùm hàm mật độ xác suất FCF} {Ví dụ số}
	
	\begin{figure}
		\centering
		\begin{subfigure}{.32\textwidth}
			\includegraphics[width=.8\textwidth]{Figs/FCF_V0}
			\caption{Trọng tâm khởi tạo}
		\end{subfigure}
		\begin{subfigure}{.32\textwidth}
			\includegraphics[width=.8\textwidth]{Figs/FCF_V1}
			\caption{Trọng tâm vòng lặp $t=1$}
		\end{subfigure}
		\begin{subfigure}{.32\textwidth}
			\includegraphics[width=.8\textwidth]{Figs/FCF_V2}
			\caption{Trọng tâm vòng lặp $t=2$}
		\end{subfigure}\\
		\begin{subfigure}{.32\textwidth}
			\includegraphics[width=.8\textwidth]{Figs/FCF_V3}
			\caption{Trọng tâm vòng lặp $t=3$}
		\end{subfigure}
		\begin{subfigure}{.32\textwidth}
			\includegraphics[width=.8\textwidth]{Figs/FCF_V4}
			\caption{Trọng tâm vòng lặp $t=4$}
		\end{subfigure}
		\begin{subfigure}{.32\textwidth}
			\includegraphics[width=.8\textwidth]{Figs/FCF_V9}
	...
	\begin{figure}[H]
				\includegraphics[width=\textwidth]{Figs/FCF_U9}
	\end{figure}
\end{frame}


\begin{frame}{1.6. Phân loại hàm mật độ xác suất}{Phương pháp Bayes}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{Figs/partition_m.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{3.2. Phân tích chùm mất cân bằng (IFCF)}{Ví dụ hình ảnh}
	
\end{frame}

\begin{frame}{3.3. Phân loại mất cân bằng (Bayes-IFCF)}{Ví dụ hình ảnh}
...
\begin{frame}{Một số bàn luận}{Về thuật toán phân loại Bayes-IFCF}
		...
		\begin{column}{0.48\textwidth}\footnotesize
			...
			\begin{block}{\textbf{Định hướng nghiên cứu}}
				...
				\begin{itemize}
					...
					\item Phát triển học không giám sát trực tuyến cho PDF động.
				\end{itemize}
