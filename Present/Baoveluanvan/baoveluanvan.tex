...
\begin{frame}{1.5. Phân tích chùm hàm mật độ xác suất} {Phân tích chùm không mờ (KCF \& HCF)}
	...
	\begin{figure}
		...
		\begin{subfigure}[b]{.45\textwidth}
			\centering
			\includegraphics[width=.6\linewidth]{Fig/KCF_L2}
			\caption{}
		\end{subfigure}
		\begin{subfigure}[b]{.45\textwidth}
			\centering
			\includegraphics[width=\linewidth]{Fig/KCF_U}
			\caption{}
		\end{subfigure}
		
		\caption{Kết quả trọng tâm và ma trận phân vùng của thuật toán KCF}\label{figs:vdu:KCF}
