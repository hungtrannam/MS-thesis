...
\begin{figure}[H]
	...
	\begin{subfigure}[h]{0.4\linewidth}
		...
		\caption{Hình ảnh Landsat}
	\end{subfigure}
	\begin{subfigure}[h]{0.47\linewidth}
		\centering
		\includegraphics[width=\linewidth]{APP_pdf}
		\caption{Mật độ của các khối màu ($4\times4$)}
	\end{subfigure}
...
\begin{table*}[h]\scriptsize
	\caption{Comparison of state-of-the-art methods with varying IR (Example 3).}
	\label{tab:EX3_EVA}
	\centering
	\begin{tabular*}{\textwidth}{@{\extracolsep\fill}llcccc@{\extracolsep\fill}}
		\toprule
		\textbf{Metric} & \textbf{IR} 
