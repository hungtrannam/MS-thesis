...
Tuy nhiên, $	\nabla^2_{\theta_i}\psi_i(\theta_i)$ chỉ lồi nghiêm ngặt trong một số khoảng cách như $\mathcal{L}_2$, $D^2_H$, hoặc $W_2$, trong khi với các khoảng cách khác như $D_{BC}$, $D_{KL}$, hoặc $D_{JS}$ có thể không duy nhất nghiệm toàn cục. Bổ đề~\ref{lem:Hellinger} chứng minh công thức thành lập trọng tâm đối với khoảng cách $D^2_H$.
...
\chm{
	Giữ $\bm U$ cố định, xét $\psi_i(\theta_i)=\sum_{j=1}^n \frac{1}{\omega_i}\,(\mu_{ij})^{m}\,D_H^2(\theta_i,f_j)$. 
...
Tổng thể, Bảng~\ref{tab:KCTT} và Hình~\ref{fig:trongtam_3KC} thể hiện sự khác biệt các khoảng cách $\mathcal{L}_2$, $D_H^2$ và $W_2$ trong xác định trọng tâm chùm gồm ba hàm mật độ xác suất, cho thấy hình dạng, vị trí, và phân tán của nó.
...
Các thuật toán phân chùm được triển khai với nhiều loại khoảng cách khác nhau, bao gồm $\mathcal{L}_2$, $D_H$, $D_{BC}$, $D_{JS}$ và $W_2$, như được trình bày trong Bảng~\ref{tab1:KC_PDF}. Kết quả chi tiết được trình bày trong Hình~\ref{fig:CD:vdu:gauss1} thể hiện giá trị trung vị của các chỉ số đánh giá phân chùm qua kiểm định Friedmanc.
...
Vì vậy, ta có thể tính được xác suất hậu nghiệm của các hàm mật độ kiểm tra với $\tau = \overline{D_{ij}}$ là $$\mathbb{P}(c=c_i\,;f=f^{(test)}_j)=\frac{\bm U_{ij} \exp(-\bm D_{ij}/\tau)}{\sum_s\bm U_{sj} \exp(-\bm D_{sj}/\tau)}= \begin{bmatrix}
...
\begin{figure*}[h]
	...
	\begin{subfigure}[h]{0.32\textwidth}
		...
		\caption{$k=10$}
	\end{subfigure}
	\caption{Phương pháp IFCF được đề xuất áp dụng cho ảnh Landsat}\label{fig:APP}
\end{figure*}
...
\begin{table}[H]
	\centering
	\scriptsize
	\caption{Kết quả so sánh các mô hình Bayes với các tiên nghiệm khác nhau đối với Ví dụ~\ref{vidu:dat}}
...
\begin{align*}
	...
	= 1{,}4,\\
	&\text{với } \theta_{\mathcal{F}} = (0{,}3 + 1{,}0)/2 = 0{,}65\,; \quad 
...
\begin{table}[H]
	...
	\begin{tabular*}{\textwidth}{@{\extracolsep\fill}p{1.5cm}ccccccccp{2cm}@{\extracolsep\fill}}
		...
		\midrule
$D_{H}$                 & 4.0 & -0.001551 & 0.017663 & -0.019214 & 0.93993  &  0.000000 & negligible &  0.000000 & negligible \\
$\mathcal{L}_2$         & 3.9 & -0.010574 & 0.009523 & -0.020588 & 0.932119 &  0.428897 & small      &  0.428897 & small \\
$D_{\mathrm{JS}}$       & 3.8 & -0.001818 & 0.011585 & -0.013402 & 0.93993  &  0.012035 & negligible & -0.556951 & medium \\
$W_2$                   & 2.1 &  0.881896 & 0.118104 &  0.450172 & 1.000000 & -7.056713 & large      & -7.103256 & large \\
$D_{\mathrm{BC}}$       & 1.2 &  0.883307 & 0.003776 &  0.879531 & 1.000000 & -46.730339 & large     & -0.011391 & negligible \\
		\bottomrule
	\end{tabular*}
\end{table}
...
\begin{table}[H]
	\centering
	\scriptsize
	\caption{Kết quả so sánh các khoảng cách theo chỉ số đối với $NMI$ Ví dụ~\ref{vdu:gauss1}}
	\begin{tabular*}{\textwidth}{@{\extracolsep\fill}p{1.5cm}ccccccccp{2cm}@{\extracolsep\fill}}
		\toprule
		Khoảng cách & meanrank & median & mad & ci\_lower & ci\_upper & effect\_size & magnitude & effect\_size\_above & magnitude above \\
		\midrule
$D_{H}$                 & 4.2 & 0.028672 & 0.002723 & 0.025949 & 0.876524 &  0.000000 & negligible &  0.000000 & negligible \\
$\mathcal{L}_2$         & 3.9 & 0.051818 & 0.024099 & 0.027092 & 0.862962 & -0.910378 & large      & -0.910378 & large \\
$D_{\mathrm{JS}}$       & 3.6 & 0.051341 & 0.025252 & 0.026089 & 0.876524 & -0.851356 & large      &  0.013043 & negligible \\
$W_2$                   & 2.1 & 0.796297 & 0.176127 & 0.363509 & 1.000000 & -4.156832 & large      & -3.993718 & large \\
$D_{\mathrm{BC}}$       & 1.2 & 0.800313 & 0.009732 & 0.790582 & 1.000000 & -72.836544 & large     & -0.021719 & negligible \\
		\bottomrule
	\end{tabular*}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular*}{\textwidth}{@{\extracolsep\fill}p{1.5cm}ccccccccp{2cm}@{\extracolsep\fill}}
		...
		\midrule
$D_{H}$                 & 4.2 & 0.495819 & 0.029603 & 0.466216 & 0.659092 &  0.000000 & negligible &  0.000000 & negligible \\
$D_{\mathrm{JS}}$       & 4.0 & 0.495607 & 0.029312 & 0.466295 & 0.659092 &  0.004854 & negligible &  0.004854 & negligible \\
...
$D_{\mathrm{BC}}$       & 1.2 & 0.620630 & 0.006647 & 0.611582 & 0.672148 & -3.923972 & large      &  0.000000 & negligible \\
		\bottomrule
	\end{tabular*}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular*}{\textwidth}{@{\extracolsep\fill}p{1.5cm}ccccccccp{2cm}@{\extracolsep\fill}}
		...
		{Khoảng cách} & meanrank & mean & std & ci\_lower & ci\_upper & effect\_size & magnitude & effect\_size\_above & magnitude above \\
		\midrule
$D_{\mathrm{BC}}$       & 4.6 & 0.067778 & 0.064004 & -0.064007 & 0.199564 &  0.000000 & negligible &  0.000000 & negligible \\
...
$D_{H}$                 & 2.2 & 0.367436 & 0.334679 & -0.321673 & 1.056545 & -1.243690 & large      & -1.155995 & large \\
$D_{\mathrm{JS}}$       & 1.0 & 1.241478 & 1.076920 & -0.975915 & 3.458871 & -1.538590 & large      & -1.096083 & large \\
		\bottomrule
	\end{tabular*}
\end{table}
...
Khi $\omega_1 \to \infty$, ta có $
	...
	$\lim_{\omega_1 \to \infty} \mu_{i2} = 0.$ Điều này cho thấy khi tỷ lệ mất cân bằng ($\text{IR}$) tăng đến vô cùng, mức độ phân vùng mờ cho chùm lớn sẽ tiến về 1, và chùm nhỏ sẽ tiến về 0. Hiện tượng này được gọi là phân cực trong các mức độ phân vùng.
