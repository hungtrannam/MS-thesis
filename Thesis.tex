...
%\begin{figure}[H]
%\centering
%\includegraphics[width=\linewidth]{Figs/C1_khoangcach.pdf}
%\begin{flushleft}
%{\footnotesize \textit{Nguồn: Minh họa của tác giả}}
%\end{flushleft}
...
\caption{Bảng tổng kết các loại liên kết $\Delta$ giữa hai chùm hàm mật độ xác suất}
	...
	\begin{tabular*}{\columnwidth}{@{\extracolsep\fill}ll@{\extracolsep\fill}} 
			...
			\bf Liên kết & \bf                             $\Delta$                             \\ \midrule
						Liên kết đơn\footnotemark \citep{florek1951liaison}&$\min_{f\in\mathcal{F}, g\in\mathcal{G}}D(f\,,g)$\\
			Liên kết đủ\footnotemark \citep{sorensen1948method} & $\max_{f\in\mathcal{F}, g\in\mathcal{G}}D(f\,,g)$\\
			Liên kết tâm &$D(\theta_{\mathcal{F}}\,,\theta_{\mathcal{G}})$\\
