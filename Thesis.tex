...
\begin{table}[H]
	...
	\begin{tabular*}{\textwidth}{@{\extracolsep\fill}llcccc@{\extracolsep\fill}}
		\toprule
		\textbf{Khoảng cách} & \textbf{Chỉ số đánh giá} & $IR=10$ & $IR=30$ & $IR=50$ & $IR=70$ \\
		\midrule
		\multirow{5}{*}{$\mathcal{L}_1$}
		& Sil  & -- & -- & -- & -- \\
		& DI   & -- & -- & -- & -- \\
		& DBI  & -- & -- & -- & -- \\
		& ARI  & -- & -- & -- & -- \\
		...
		& NMI  & -- & -- & -- & -- \\
		\midrule
		\multirow{5}{*}{Thông tin Kulback-Leibler}
		& Sil  & -- & -- & -- & -- \\
		& DI   & -- & -- & -- & -- \\
		& DBI  & -- & -- & -- & -- \\
		& ARI  & -- & -- & -- & -- \\
...
\begin{table}[H]
	...
	\begin{tabular*}{\textwidth}{@{\extracolsep\fill}llcccc@{\extracolsep\fill}}
		\toprule
		\textbf{Tham số $m$} & \textbf{Chỉ số đánh giá} & $IR=10$ & $IR=30$ & $IR=50$ & $IR=70$ \\
		\midrule
		\multirow{5}{*}{$m=1.1$}
		& Sil  & -- & -- & -- & -- \\
		& DI   & -- & -- & -- & -- \\
...
\begin{table}[H]
	...
	\begin{tabular*}{\textwidth}{@{\extracolsep\fill}lp{4cm}p{11cm}@{\extracolsep\fill}}
		...
		2025 & Tai Vo-Van \cite{vovan2025classifying} & \\
