...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{C2_k_best_FCF.pdf}
	\begin{flushleft}
		\footnotesize\it
	...
	\end{flushleft}
	\caption[Một số chỉ số đánh giá và số chùm tối ưu được đề xuất từ phương pháp khuỷu tay]{Một số chỉ số đánh giá và số chùm tối ưu được đề xuất từ phương pháp khuỷu tay với dữ liệu hàm mật độ ở Ví dụ~\ref{VD:thubac}.}
