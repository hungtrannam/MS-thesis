...
\begin{document}
	...
	\begin{tikzpicture}
		...
		\begin{groupplot}[
			...
			\addplot+[mark=none,draw=black!60,line width=1pt]
			coordinates {(2,0) (2,\heightA) (3,\heightA) (3,0)};
			\addplot+[mark=none,draw=black!60,line width=1pt,opacity=0.7, fill=black!45]
			...
			\addplot+[mark=none,draw=black!60,,line width=1pt,opacity=0.7, fill=black!40]
